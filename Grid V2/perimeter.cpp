// From & Based on Timothy Kerston's code
...
void Perimeter::addNode(int x, int y)
{
	Node *temp = new Node;
...
void Perimeter::addNode(Point p)
{
	addNode(p.getX(), p.getY());
}

void Perimeter::addWaypoint(int x, int y)
{
...
void Perimeter::addWaypoint(Point p)
{
...
Node* Perimeter::getNodeAt(int i)
{
	Node *temp = new Node;
